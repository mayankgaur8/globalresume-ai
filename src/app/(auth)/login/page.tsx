    ...
    <div className="flex min-h-screen">
        ...
        <div className="relative z-10 space-y-8">
          <div>
            ...
            <p className="mt-4 text-slate-300 text-lg leading-relaxed">
              Build ATS-optimized resumes for any country, in any language, powered by AI.
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
            ...
            <p className="text-white text-sm leading-relaxed italic">
              &ldquo;I landed my dream job in Germany within 3 weeks of using GlobalResumeAI. The localized template
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 sm:p-12 bg-white">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-8 p-4 rounded-xl bg-slate-50 border border-slate-200 text-xs text-slate-500 space-y-1">
            <p className="font-semibold text-slate-700 mb-2">Demo credentials</p>
            <p>
              <span className="font-medium">User:</span> demo@globalresumeai.com / demo123
            </p>
            <p>
              <span className="font-medium">Admin:</span> admin@globalresumeai.com / admin123
            </p>
          </div>
        </div>
      </div>
